...
class PipelineTmaAsyncNoCluster : public Base {
 public:
  ...
  static CUTLASS_DEVICE void init_barriers(
  ...
  CUTLASS_DEVICE PipelineTmaAsyncNoCluster(
      SharedStorage& storage,
      Params params,
      ...
      : Base(
            storage,
            params,
            make_shape(_1{}, _1{}, _1{}) /*cluster_shape*/,
    ...
    static_assert(
        cute::is_same_v<InitBarriers, cute::true_type> ||
        cute::is_same_v<InitBarriers, cute::false_type>);
    static_assert(
        cute::is_same_v<InitMasks, cute::true_type> ||
