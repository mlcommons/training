...
def _mlperf_print(key, value=None, benchmark=None, stack_offset=0,
  ...
  prefix: String with which to prefix a log line. Useful for distinguishing raw
          log lines when lines need to be stitched.
...
def gnmt_print(key, value=None, stack_offset=1, deferred=False, prefix=""):
  return _mlperf_print(key=key, value=value, benchmark=GNMT,
                       ...
                       deferred=deferred, root_dir=ROOT_DIR_GNMT, prefix=prefix)
...
if __name__ == '__main__':
  ncf_print(INPUT_SIZE, 1024, prefix="RAW_")
